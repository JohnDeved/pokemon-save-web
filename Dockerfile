...
LUA_SCRIPT_PATH="/app/test_data/mgba_http_server_enhanced.lua"
...
echo "🚀 Starting mGBA with Pokémon Emerald and HTTP server..."
echo "   ROM: \$ROM_PATH"
...
echo "🌐 HTTP server should be available at http://localhost:7102"
