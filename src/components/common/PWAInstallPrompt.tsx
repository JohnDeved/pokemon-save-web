          ...
          <div className="bg-zinc-800 border border-zinc-600 rounded-lg p-3 shadow-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-medium text-zinc-100">Install Pokemon Save Editor</h3>
                <p className="text-xs text-zinc-300 mt-1">Get the full app experience with offline support and faster loading.</p>
              </div>
              <button onClick={handleDismiss} className="flex-shrink-0 text-zinc-400 hover:text-zinc-200 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center -mt-1 -mr-1">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Button onClick={handleDismiss} variant="outline" className="flex-1 px-3 py-2 border border-zinc-600 text-zinc-300 hover:text-zinc-100 hover:border-zinc-500 rounded text-sm transition-colors min-h-[44px]" type="button">
                Not now
              </Button>
            </div>
          </div>
