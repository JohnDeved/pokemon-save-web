        ...
        <ScrollableContainer className="absolute inset-0 px-4 pt-3 pb-4 overflow-y-auto custom-scrollbar">
          <div className="flex flex-col gap-3">
            <div className="text-foreground">
              {pokemon ? <PokemonNatureCombobox value={pokemon.data.nature} onChange={nature => setNature(pokemon.id, nature)} asText triggerClassName="font-pixel text-lg sm:text-xl text-foreground" /> : <Skeleton.Text className="font-pixel text-lg sm:text-xl">{natureName}</Skeleton.Text>}
            </div>
