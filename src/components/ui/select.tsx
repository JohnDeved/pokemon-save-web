  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport className={cn('p-1 custom-scrollbar', position === 'popper' && 'h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)] scroll-my-1')}>{children}</SelectPrimitive.Viewport>
