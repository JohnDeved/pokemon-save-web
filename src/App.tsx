...
export const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-3 lg:p-4 font-pixel text-slate-100">
        <SaveFileDropzone
        ...
        />
        {hasSaveData && (
          <main className="max-w-6xl mx-auto z-10 gap-3 flex flex-col">
            {isMobile
              ? (
